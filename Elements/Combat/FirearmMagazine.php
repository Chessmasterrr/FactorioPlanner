...
/**
 * Class for the firearm magazine.
 * @author Chessmasterrr
 */
class FirearmMagazine extends \Factorioplanner\Elements\Element
{
    /**
     * Constructor
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->name = 'firearmMagazine';
        $this->image = 'firearm-magazine.png';
        $this->link = 'firearm_magazine';
        $this->time = 1;        
    }
    ...
    public function createDependencies()
    {
        ...
        $this->addDependency('Factorioplanner\Elements\Intermediateproduct\IronPlate', 4);
    }
