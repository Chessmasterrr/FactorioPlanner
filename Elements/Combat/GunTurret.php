...
/**
 * Class for the gun turret.
 * @author Chessmasterrr
 */
class GunTurret extends \Factorioplanner\Elements\Element
{
    /**
     * Constructor
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->name = 'gunTurret';
        $this->image = 'gun-turret.png';
        $this->link = 'gun_turret';
        $this->time = 8;        
    }
    ...
    public function createDependencies()
    {
        ...
        $this->addDependency('Factorioplanner\Elements\Intermediateproduct\CopperPlate', 10);
        $this->addDependency('Factorioplanner\Elements\Intermediateproduct\IronGearWheel', 10);
        $this->addDependency('Factorioplanner\Elements\Intermediateproduct\IronPlate', 20);
    }
