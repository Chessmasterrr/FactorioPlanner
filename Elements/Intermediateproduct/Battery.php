...
/**
 * Class for the battery.
 * @author Chessmasterrr
 */
class Battery extends \Factorioplanner\Elements\Element
{
    /**
     * Constructor
    ...
    public function createDependencies()
    {
        ...
        $this->addDependency('Factorioplanner\Elements\Intermediateproduct\CopperPlate', 1);
        $this->addDependency('Factorioplanner\Elements\Intermediateproduct\IronPlate', 1);
        $this->addDependency('Factorioplanner\Elements\Intermediateproduct\SulfuricAcid', 20);
    }
