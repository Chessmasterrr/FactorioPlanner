...
/**
 * Class for the copper cable.
 * @author Chessmasterrr
 */
class CopperCable extends \Factorioplanner\Elements\Element
{
    /**
     * Constructor
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->name = 'copperCable';
        $this->image = 'copper-cable.png';
        $this->link = 'copper_cable';
        $this->time = 0.25;
    }
