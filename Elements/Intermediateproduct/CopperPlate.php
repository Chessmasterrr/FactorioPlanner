...
/**
 * Class for the copper plate.
 * @author Chessmasterrr
 */
class CopperPlate extends \Factorioplanner\Elements\Element
{
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->name = 'copperPlate';
        $this->image = 'copper-plate.png';
        $this->link = 'copper_plate';
        $this->time = 3.5;
    ...
    public function createDependencies()
    {
        ...
        $this->addDependency('Factorioplanner\Elements\Ressource\CopperOre', 1);
    }
