...
/**
 * Class for the electric engine unit.
 * @author Chessmasterrr
 */
class ElectricEngineUnit extends \Factorioplanner\Elements\Element
{
    /**
     * Constructor
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->name = 'electricEngineUnit';
        $this->image = 'electric-engine-unit.png';
        $this->link = 'electric_engine_unit';
        $this->time = 10;
    ...
    public function createDependencies()
    {
        ...
        $this->addDependency('Factorioplanner\Elements\Intermediateproduct\Lubricant', 15);
    }
