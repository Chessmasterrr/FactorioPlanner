...
/**
 * Class for the electronic circuit.
 * @author Chessmasterrr
 */
class ElectronicCircuit extends \Factorioplanner\Elements\Element
{
    /**
     * Constructor
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->name = 'electronicCircuit';
        $this->image = 'electronic-circuit.png';
        $this->link = 'electronic_circuit';
        $this->time = 0.5;        
    }
    ...
    public function createDependencies()
    {
        ...
        $this->addDependency('Factorioplanner\Elements\Intermediateproduct\CopperCable', 3);
    }
