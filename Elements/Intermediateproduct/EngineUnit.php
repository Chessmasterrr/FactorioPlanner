...
/**
 * Class for the engine unit.
 * @author Chessmasterrr
 */
class EngineUnit extends \Factorioplanner\Elements\Element
{
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->name = 'engineUnit';
        $this->image = 'engine-unit.png';
        $this->link = 'engine_unit';
        $this->time = 10;
    ...
    public function createDependencies()
    {
        ...
        $this->addDependency('Factorioplanner\Elements\Logistic\Pipe', 2);
