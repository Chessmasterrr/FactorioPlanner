...
/**
 * Class for the heavy oil.
 * @author Chessmasterrr
 */
class HeavyOil extends \Factorioplanner\Elements\Element
{
/**
     * Constructor
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->name = "heavyOil";
        $this->image = "fluid/heavy-oil.png";
        $this->link = 'heavy_oil';
        $this->time = 5;
    }
    ...
    public function createDependencies()
    {
        ...
        if ($oilprocessing == "basic") {
            $this->addDependency('Factorioplanner\Elements\Ressource\CrudeOil', 3.3333);
        }
        if ($oilprocessing == "advanced") {
            $this->addDependency('Factorioplanner\Elements\Ressource\CrudeOil', 10);
            $this->addDependency('Factorioplanner\Elements\Ressource\Water', 5);
        }
    }
