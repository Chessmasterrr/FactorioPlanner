...
/**
 * Class for the iron gear wheel.
 * @author Chessmasterrr
 */
class IronGearWheel extends \Factorioplanner\Elements\Element
{
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->name = 'ironGearWheel';
        $this->image = 'iron-gear-wheel.png';
        $this->link = 'iron_gear_wheel';
        $this->time = 0.5;
    ...
    public function createDependencies()
    {
        ...
        $this->addDependency('Factorioplanner\Elements\Intermediateproduct\IronPlate', 2);
    }
