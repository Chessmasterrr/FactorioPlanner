...
/**
 * Class for the iron plate.
 * @author Chessmasterrr
 */
class IronPlate extends \Factorioplanner\Elements\Element
{
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->name = 'ironPlate';
        $this->image = 'iron-plate.png';
        $this->link = 'iron_plate';
        $this->time = 3.5;
    ...
    public function createDependencies()
    {
        ...
        $this->addDependency('Factorioplanner\Elements\Ressource\IronOre', 1);
    }
