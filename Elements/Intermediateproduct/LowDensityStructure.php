...
/**
 * Class for the low density structure.
 * @author Chessmasterrr
 */
class LowDensityStructure extends \Factorioplanner\Elements\Element
{
    /**
     * Constructor
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->name = 'lowDensityStructure';
        $this->image = 'rocket-structure.png';
        $this->link = 'low_density_structure';
        $this->time = 30;
    }
    ...
    public function createDependencies()
    {
        ...
        $this->addDependency('Factorioplanner\Elements\Intermediateproduct\PlasticBar', 5);
        $this->addDependency('Factorioplanner\Elements\Intermediateproduct\SteelPlate', 10);
    }
}
