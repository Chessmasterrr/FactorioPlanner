...
/**
 * Class for the lubricant.
 * @author Chessmasterrr
 */
class Lubricant extends \Factorioplanner\Elements\Element
{
/**
     * Constructor
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->name = "lubricant";
        $this->image = "fluid/lubricant.png";
        $this->link = 'lubricant';
        $this->time = 1;
    }
    ...
    public function createDependencies()
    {
        ...
        $this->addDependency('Factorioplanner\Elements\Intermediateproduct\HeavyOil', 1);
    }
