...
/**
 * Class for the rocket control unit.
 * @author Chessmasterrr
 */
class RocketControlUnit extends \Factorioplanner\Elements\Element
{
    /**
     * Constructor
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->name = 'rocketControlUnit';
        $this->image = 'rocket-control-unit.png';
        $this->link = 'rocket_control_unit';
        $this->time = 30;
    }
    ...
    public function createDependencies()
    {
        ...
        $this->addDependency('Factorioplanner\Elements\Intermediateproduct\ProcessingUnit', 1);
        $this->addDependency('Factorioplanner\Elements\Production\SpeedModule', 1);
    }
