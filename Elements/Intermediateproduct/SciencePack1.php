...
/**
 * Class for the science pack 1.
 * @author Chessmasterrr
 */
class SciencePack1 extends \Factorioplanner\Elements\Element
{
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->name = "sciencePack1";
        $this->image = "science-pack-1.png";
        $this->link = 'science_pack_1';
        $this->time = 5;
