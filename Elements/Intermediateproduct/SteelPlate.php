...
/**
 * Class for the steel plate.
 * @author Chessmasterrr
 */
class SteelPlate extends \Factorioplanner\Elements\Element
{
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->name = 'steelPlate';
        $this->image = 'steel-plate.png';
        $this->link = 'steel_plate';
        $this->time = 17.5;
    ...
    {
        $this->setProducer("furnace");
        $this->addDependency('Factorioplanner\Elements\Intermediateproduct\IronPlate', 5);
    }
