...
/**
 * Class for the stone brick.
 * @author Chessmasterrr
 */
class StoneBrick extends \Factorioplanner\Elements\Element
{
    /**
     * Constructor
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->image = "stone-brick.png";
        $this->link = 'stone_brick';
        $this->time = 3.5;
    }
    ...
    public function createDependencies()
    {
        ...
        $this->addDependency('Factorioplanner\Elements\Ressource\Stone', 2);
    }
}
