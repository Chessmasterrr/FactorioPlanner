...
/**
 * Class for the transport belt.
 * @author Chessmasterrr
 */
class TransportBelt extends \Factorioplanner\Elements\Element
{
    /**
     * Constructor
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->name = "transportBelt";
        $this->image = "transport-belt.png";
        $this->link = 'transport_belt';
        $this->time = 0.25;
    }
    ...
    public function createDependencies()
    {
        ...
        $this->addDependency('Factorioplanner\Elements\Intermediateproduct\IronPlate', 0.5);
        $this->addDependency('Factorioplanner\Elements\Intermediateproduct\IronGearWheel', 0.5);
    }
}
