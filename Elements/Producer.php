...
/**
 * Abstract class for all assembling machines to store their specific values.
 * @author Chessmasterrr
 */
abstract class Producer extends Element
{
    ...
    /**
     * Getter
     * @return float Crafting speed of the assembling machine.
     */
