...
/**
 * Class for the assembling machine 1.
 * @author Chessmasterrr
 */
class AssemblingMachine1 extends \Factorioplanner\Elements\Producer
{
/**
     * Constructor
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->image = "assembling-machine-1.png";
        $this->link = 'assembling_machine_1';
        $this->craftingSpeed = 0.5;
        $this->time = 0.5;
