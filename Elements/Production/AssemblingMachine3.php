...
/**
 * Class for the assembling machine 3.
 * @author Chessmasterrr
 */
class AssemblingMachine3 extends \Factorioplanner\Elements\Producer
{
/**
     * Constructor
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->image = "assembling-machine-3.png";
        $this->link = 'assembling_machine_3';
    ...
    public function createDependencies()
    {
        ...
        $this->addDependency('Factorioplanner\Elements\Production\AssemblingMachine2', 2);
        $this->addDependency('Factorioplanner\Elements\Production\SpeedModule', 4);
