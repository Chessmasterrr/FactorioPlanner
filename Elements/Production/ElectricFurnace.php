...
/**
 * Class for the electric furnace.
 * @author Chessmasterrr
 */
class ElectricFurnace extends \Factorioplanner\Elements\Furnace
{
/**
     * Constructor
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->name = "electricFurnace";
        $this->image = "electric-furnace.png";
        $this->link = 'electric_furnace';
    ...
    public function createDependencies()
    {
        ...
        $this->addDependency('Factorioplanner\Elements\Intermediateproduct\AdvancedCircuit', 5);
