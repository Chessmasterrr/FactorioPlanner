...
/**
 * Class for the oil refinery.
 * @author Chessmasterrr
 */
class OilRefinery extends \Factorioplanner\Elements\Producer
{
/**
     * Constructor
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->image = "oil-refinery.png";
        $this->craftingSpeed = 1;
        $this->time = 10;
        $this->link = 'oil_refinery';
    ...
    public function createDependencies()
    {
        ...
        $this->addDependency('Factorioplanner\Elements\Intermediateproduct\ElectronicCircuit', 10);
        ...
        $this->addDependency('Factorioplanner\Elements\Intermediateproduct\SteelPlate', 15);
