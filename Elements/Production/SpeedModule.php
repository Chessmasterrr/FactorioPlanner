...
/**
 * Class for the speed module.
 * @author Chessmasterrr
 */
class SpeedModule extends \Factorioplanner\Elements\Element
{
    /**
     * Constructor
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->name = "speedModule";
        $this->image = "speed-module.png";
        $this->link = 'speed_module';
        $this->time = 15;
