...
/**
 * Class for the stone furnace.
 * @author Chessmasterrr
 */
class StoneFurnace extends \Factorioplanner\Elements\Furnace
{
/**
     * Constructor
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->image = "stone-furnace.png";
        $this->link = 'stone_furnace';
    ...
    public function createDependencies()
    {
        ...
        $this->addDependency('Factorioplanner\Elements\Ressource\Stone', 5);
    }
