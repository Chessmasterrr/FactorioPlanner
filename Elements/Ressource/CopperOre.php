...
/**
 * Class for the copper ore.
 * @author Chessmasterrr
 */
class CopperOre extends \Factorioplanner\Elements\Ressource
{
/**
     * Constructor
    ...
    public function __construct($parent, $val)
    {
        ...
        $this->name = "copperOre";
        $this->image = "copper-ore.png";
        $this->link = 'copper_ore';
        $this->miningHardness = 0.9;
        $this->miningTime = 2;
